...
if __name__ == "__main__":
    ...
    parser.add_argument("--crosscov-mode", type=str, default="select", choices=["select", "compress", "evict"], help="CrossCov runtime mode: select (full cache top-k), compress (rank-r cache + selective reconstruction), evict (static query-weighted eviction)")
    parser.add_argument("--evict-ratio", type=float, default=0.5, help="fraction of tokens to evict in crosscov-mode=evict")
